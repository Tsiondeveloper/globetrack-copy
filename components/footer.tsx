      ...
      <div>
        <div className="py-12 px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Globetrack services</h3>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  ...
                  <a href="tel:+19097765598" className="text-muted-foreground hover:text-foreground transition-colors">
                    +1 (909) 776-5598
                  </a>
                </li>
                <li className="flex items-center">
                  <Mail className="h-5 w-5 mr-2 text-muted-foreground" />
                  <a href="mailto:support@globetrack.services" className="text-muted-foreground hover:text-foreground transition-colors">
                    support@globetrack.services
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div className="border-t py-6 px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              &copy; {currentYear} Globetrack services. All rights reserved.
            </p>
