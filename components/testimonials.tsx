...
const testimonials = [
  {
    ...
    content:
      "Globetrack services has transformed our logistics operations. Their reliable service and real-time tracking have significantly reduced our shipping delays and improved customer satisfaction. The specialized handling for fragile items has been a game-changer for our business.",
    avatar:
  ...
  },
  {
    ...
    content:
      "As someone who ships products globally, I've tried many delivery services, but Globetrack services stands out with their exceptional international shipping solutions. Their customs expertise has saved me countless hours and prevented costly delays.",
    avatar:
  ...
  },
  {
    ...
    content:
      "The customer service at Globetrack services is unmatched. When I had an urgent shipment that needed special handling, their team went above and beyond to ensure it arrived on time. Their dedication to their clients is truly impressive.",
    avatar:
  ...
  },
  {
    ...
    content:
      "We've reduced our shipping costs by 30% since switching to Globetrack services while improving delivery times. Their integrated solutions approach has streamlined our entire supply chain. I highly recommend their services to any business looking to optimize their logistics.",
