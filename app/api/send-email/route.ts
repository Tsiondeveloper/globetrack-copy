...
const transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: "globetracklogistics82@gmail.com",
    pass: "spgt kaqm iqdq viaa",
  },
})
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>This is an automated message from the Globetrack services system.</p>
          </div>
        </div>
      </body>
    </html>
...
export async function POST(request: Request) {
  try {
    ...
    const mailOptions = {
      from: `"Globetrack Services" <hello@globetrack.services>`,
      to,
      subject,
      html: emailHtml,
    }
